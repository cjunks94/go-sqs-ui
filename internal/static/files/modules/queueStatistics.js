...
export class QueueStatistics {
  ...
  calculateBasicStatistics(queue) {
    ...
    const oldestTimestamp = attrs.OldestMessageAge ? now - parseInt(attrs.OldestMessageAge) * 1000 : null;
    ...
    return {
      ...
      newestMessageTimestamp: attrs.LastModifiedTimestamp ? parseInt(attrs.LastModifiedTimestamp) * 1000 : null,
